...
!function (e, t) {
  "object" == (typeof exports === "undefined" ? "undefined" : (0, _typeof2["default"])(exports)) && "object" == (typeof module === "undefined" ? "undefined" : (0, _typeof2["default"])(module)) ? module.exports = t(require("@antv/g6")) : "function" == typeof define && define.amd ? define(["@antv/g6"], t) : "object" == (typeof exports === "undefined" ? "undefined" : (0, _typeof2["default"])(exports)) ? exports.GGEditorCore = t(require("@antv/g6")) : e.GGEditorCore = t(e.G6);
}(window, function (e) {
  return function (e) {
    var t = {};
    ...
    function c(e, t) {
      ...
      return o.forEach(function (t, o) {
        var a,
            c,
            u = (a = e, c = t, Math.sqrt(Math.pow(a.x - c.x, 2) + Math.pow(a.y - c.y, 2)));
        u < i && (n = t, i = u, r = o);
      }), {
        point: n,
        index: r
    ...
    function f(e, t) {
      for (var n, r, o, i, a, c = 1 / 0, u = 0; u < t.length - 1; u++) {
        ...
        if (d(f = s ? {
          ...
          var h = (i = e, a = f, Math.pow(i.x - a.x, 2) + Math.pow(i.y - a.y, 2));
          c > h && (c = h, n = u, r = f, o = s);
        }
      }
    ...
    var i = n(7),
        ...
        c = n(4),
        u = {
      getActivedStyle: function getActivedStyle() {},
    ...
    function s(e, t, n) {
      var r = [];
      return c.isString(e) ? r = [t, e] : c.isArray(e) ? (e.unshift(t), r = e) : r = [t], n && r.unshift(n + "-base"), r;
    }

    i.registerNode("page-base", r({}, u)), i.registerEdge("page-base", r({}, u)), i.registerGroup("page-base", r({}, u)), i.registerGuide("page-base", r({}, u)), a.setRegister = function (e, t, n) {
    ...
    }, a.setRegister(a, "page"), n(44), e.exports = a;
  }, function (e, t, n) {
    function r(e, t, n) {
      return t in e ? Object.defineProperty(e, t, {
        value: n,
    ...
    var l = n(21),
      ...
      function t(e) {
        ...
        return d.each(m, function (e) {
          d.mix(r, e.CFG);
        }), d.mix(!0, r, e), (n = c(this, u(t).call(this, r))).isPage = !0, n.type = "page", n._init(), n;
      }
      ...
      return function (e, t) {
        ...
        value: function value(e, t) {
          ...
          } else e[0].isEdge ? n = t.addShape("path", {
            attrs: o({
              path: "M0 0L 1 1"
        ...
        value: function value(e) {
          ...
          return i.saveImage(o({
            ...
            afterTransform: function afterTransform() {
              r.setSelected(t, !0), r.setActived(n, !0);
            }
          }, e));
        }
      }, {
        ...
        value: function value(e) {
          var t = this.getGraph(),
              ...
              i = [n.minX, n.minY, 1],
              a = [n.maxX, n.maxY, 1];
          return d.vec3.transformMat3(i, i, e), d.vec3.transformMat3(a, a, e), a[0] < 100 && d.mat3.translate(e, e, [100 - a[0], 0]), a[1] < 100 && d.mat3.translate(e, e, [0, 100 - a[1]]), i[1] > o - 100 && d.mat3.translate(e, e, [0, o - 100 - i[1]]), i[0] > r - 100 && d.mat3.translate(e, e, [r - 100 - i[0], 0]), !0;
        }
      }, {
        key: "setSignal",
        value: function value(e, t) {
    ...
    e.exports = function (e) {
      ...
      getPanCanvasBehaviour: function getPanCanvasBehaviour(e) {
        return function (t) {
          var n,
              r,
              a = t.getGraph();
          a.behaviourOn("canvas:mouseenter", function () {
            ...
            }), r = a.getMatrix(), t.setCapture(!1));
          }), a.behaviourOn("drag", function (e) {
            if (n) {
              var i = e.domX - n.x,
                  c = e.domY - n.y,
                  u = [];
              o.mat3.translate(u, r, [i, c]), t.translateLimt(u) && (a.updateMatrix(u), a.draw());
            }
          }), a.behaviourOn("mouseup", function () {
            n && (n = void 0, r = void 0, t.setCapture(!0), t.css({
              cursor: i.cursor.beforePanCanvas
            }));
          });
        };
      },
      getLabelTextByTextLineWidth: function getLabelTextByTextLineWidth(e, t) {
    ...
    var i = n(7),
      ...
      computeKey: {
        ...
        s = r({}, i.Util, a, {
      getNodeSize: function getNodeSize(e) {
        if (e) {
          if (i.Util.isNumber(e)) return [e, e];
      ...
      getTypeAndChar: function getTypeAndChar(e) {
        var t;

        for (var n in e = "" + e, u) {
          for (var r in t = n, u[n]) {
            if (r === e) return {
              type: t,
              character: u[n][r]
            };
      ...
      getKeyboradKey: function getKeyboradKey(e) {
      ...
      pointLineDistance: function pointLineDistance(e, t, n, r, o, a) {
        var c = [n - e, r - t];
        if (i.Util.vec2.exactEquals(c, [0, 0])) return NaN;
        var u = [-c[1], c[0]];
        i.Util.vec2.normalize(u, u);
        var s = [o - e, a - t];
        return Math.abs(i.Util.vec2.dot(s, u));
      },
      getRectByBox: function getRectByBox(e, t, n) {
      ...
      objectToValues: function objectToValues(e) {
        var t,
            n = [];
      ...
      getContrast: function getContrast(e, t) {
        var n = {};
        return i.Util.each(t, function (t, r) {
          n[r] = e[r];
        }), n;
      },
      arrowTo: function arrowTo(e, t, n, r, o, a, c) {
        var u = [a - r, c - o],
            s = i.Util.vec2.angleTo(u, [1, 0], !0);
        return e.transform([["r", s], ["t", t, n]]), e;
      },
      setEndOfContenteditable: function setEndOfContenteditable(e) {
        var t, n;
      ...
      delegateEvent: function delegateEvent(e, t, n, r) {
        return s.addEventListener(e, t, function (t) {
          for (var o = t.target || t.srcElement; o !== e;) {
            s.matches(o, n) && r.call(o, Array.prototype.slice.call(arguments)), o = o.parentNode;
          }
        });
      },
      Palettes: c
    ...
    var d = n(7),
      ...
      function t(e) {
        ...
        var r = {
          ...
          graph: {
            ...
            layout: new d.Layouts.Mindmap({
              direction: "H",
              getSubTreeSep: function getSubTreeSep(e) {
        ...
        return h.each(g, function (e) {
          h.mix(o, e.CFG);
        }), h.mix(!0, r, o, e), (n = c(this, s(t).call(this, r))).isMind = !0, n;
      }
      ...
      return function (e, t) {
        ...
        value: function value() {
          var e = this;
          u(s(t.prototype), "_init", this).call(this), h.each(g, function (t) {
            t.INIT && e[t.INIT]();
          });
          var n = this.getGraph(),
          ...
          if (this.set("hotAreaGroup", i), n.edge().shape(function (e) {
            if (n.find(e.target).getModel().isPlaceholder) return "mind-placeholder-edge";
          }), r && this.read(r), "default" === o) {
            if (r) {
              var a = this.getRoot(),
                  c = n.find(a.id);
            ...
            l.append = !1, l.appendChild = !1, l.selectAll = !1, l["delete"] = !1;
          }
        ...
        value: function value() {
          ...
          n.on("keydown", function (e) {
            ...
            if (t.isEdge) {
              ...
              h.toBack(r, r.getParent()), r.setSilent("capture", !1);
            }

            n.parent || (t.isRoot = !0, t.deleteable = !1, t.collapseExpand = !1, t.appendable = !1, t.dragable = !1);
        ...
        value: function value(e) {
          ...
          if (e) {
            ...
            if (i) {
              var a = i.getModel();
              e.hierarchy = a.hierarchy + 1, "mind-placeholder" !== e.shape && (2 === e.hierarchy && (e.shape = n, e.side || (e.side = o)), 3 === e.hierarchy && (e.shape = r));
            }
          } else (e = this.getRoot()).hierarchy = 1;

          h.traverseTree(e, function (e, t) {
            e.hierarchy = t.hierarchy + 1, e.side || (e.side = o), t.side && (e.side = t.side), 2 === e.hierarchy ? e.shape = n : 3 === e.hierarchy && (e.shape = r);
          }, function (e) {
            return e.children;
          });
        }
        ...
        value: function value(e) {
          ...
          if (n) {
            var r,
                o = e.domEvent,
                i = h.getKeyboradKey(o);
            "ArrowUp" !== i || n.isRoot ? "ArrowDown" !== i || n.isRoot ? "ArrowLeft" === i ? r = this._arrowLeftItem(n) : "ArrowRight" === i && (r = this._arrowRightItem(n)) : r = this._arrowBottomItem(n) : r = this._arrowTopItem(n), r && (r = t.find(r.id)).isVisible() && (this.clearSelected(), this.setSelected(r, !0));
          }
        }
      }, {
        key: "showLabelEditor",
        value: function value(e) {
          ...
          if (n && 1 === r.length && !t.metaKey && !t.ctrlKey) {
            ...
            n && (this.beginEditLabel(n), o.innerHTML = r, h.setEndOfContenteditable(o));
          }
        }
      }, {
        ...
        value: function value(e) {
          var t = this.get("_graph"),
            ...
            y: n.maxY
              ...
              c = t.getWidth(),
              u = t.getHeight();
          i.x < 0 && t.translate(16 - i.x, 0), i.y < 0 && t.translate(0, 16 - i.y), a.x > c && t.translate(c - a.x - 16, 0), a.y > u && t.translate(0, u - a.y - 16);
        }
      }, {
        ...
        value: function value(e) {
          ...
          t.shape = n, this._setHierarchy(t);
        }
      }, {
        key: "_beforeAdd",
        value: function value(e) {
          ...
          e.push({
            ...
            if (!n.isPlaceholder && c && c.isVisible()) {
              var u = function (e, t, n) {
                var r = n.children,
                    o = e;
                if (!n.parent) for (; r[o] && r[o].side !== t.side;) {
                  o++;
                }
                ...
                if (r[o] && r[o].side === t.side) return r[o];
              }(a + 1, n, i),
                  s = function (e, t, n) {
                var r = n.children,
                    o = e;
            ...
            return e.children;
          }), this.set("hotAreas", e), i && this._drawHotAreaShape();
        }
      }, {
        key: "hideHotArea",
        value: function value() {
          var e = this.get("_graph");
          this.get("hotAreaGroup").clear(), e.draw(), this.set("showHotArea", !1);
        }
      }, {
        key: "showHotArea",
        value: function value() {
        ...
        value: function value(e) {
          ...
          return this.get("hotAreas").forEach(function (n) {
            if (e.x > n.minX && e.x < n.maxX && e.y > n.minY && e.y < n.maxY) return t = n, !1;
          }), t;
        }
      }, {
        key: "saveExpandImage",
        value: function value(e) {
          ...
          return a.saveImage(o({
            ...
            beforeTransform: function beforeTransform() {
              ...
              }), a.layout(), n = i.getSelected().map(function (e) {
                return e.id;
              }), r = i.getSelected().map(function (e) {
                return e.id;
              }), i.clearSelected(), i.clearActived();
            },
            afterTransform: function afterTransform() {
              ...
              }), i.setSelected(n, !0), i.setActived(r, !0);
            }
          }, e));
        }
      }, {
        ...
        value: function value() {
          ...
          return e.roots.forEach(function (e) {
            h.traverseTree(e, function (e) {
              delete e.x, delete e.y, delete e.width, delete e.height, delete e.parent, delete e.nth, delete e.hierarchy, delete e.index, delete e.shape;
            }, function (e) {
              return e.children;
            }, !0);
          }), e;
    ...
    }), f.setRegister(p, "mind", "page"), e.exports = p;
  }, function (e, t, n) {
    function r(e, t) {
      for (var n = 0; n < t.length; n++) {
        var r = t[n];
    ...
    var o = function (e) {
      ...
      getMindNodeSide: function getMindNodeSide(e) {
        var t = e.getModel();
    ...
    var c = n(1),
      ...
      function t(e) {
        ...
        return s.mix(!0, r, {}, e), (n = o(this, i(t).call(this, r))).isFlow = !0, n;
      }
    ...
    c.setRegister(l, "flow", "diagram"), e.exports = l;
  }, function (e, t, n) {
    function r(e) {
      return (r = "function" == typeof Symbol && "symbol" == (0, _typeof2["default"])(Symbol.iterator) ? function (e) {
        return (0, _typeof2["default"])(e);
    ...
    var s = n(16),
      ...
      function t(e) {
        ...
        return d.mix(!0, r, {}, e), (n = i(this, c(t).call(this, r))).isBPMN = !0, n;
      }
      ...
      return function (e, t) {
        ...
        key: "_init",
        value: function value() {
          a(c(t.prototype), "_init", this).call(this), this._initArrowController();
        }
      }, {
        ...
        value: function value(e, t) {
          ...
          return o.setAttribute("draggable", "true"), d.addEventListener(o, "dragstart", function () {
            var e = o.hoverNode,
                t = {
              shape: "bpmn-base",
              source: e.id,
            ...
            n.setSignal("dragEdge", !0), n.beginAdd("edge", t), n.set("addEdgeConfig", {
              addModel: t,
              delegation: i,
              startPoint: {
                x: r.centerX,
        ...
        value: function value() {
          ...
          e.appendChild(o), e.appendChild(i), e.appendChild(a), e.appendChild(c), t.topArrow = o, t.bottomArrow = i, t.leftArrow = a, t.rightArrow = c;
        }
      }, {
        key: "bindEvent",
        value: function value() {
      ...
      }]) && o(n.prototype, r), l && o(n, l), t;
    }();

    l.setRegister(f, "bpmn", "diagram"), e.exports = f;
  }, function (e, t, n) {
    function r(e) {
      return (r = "function" == typeof Symbol && "symbol" == (0, _typeof2["default"])(Symbol.iterator) ? function (e) {
        return (0, _typeof2["default"])(e);
    ...
    var s = n(7),
      ...
      function t(e) {
        ...
        return d.each(m, function (e) {
          d.mix(o, e.CFG);
        }), d.mix(!0, r, o, e), (n = i(this, c(t).call(this, r))).isFlow = !0, n;
      }
      ...
      return function (e, t) {
        ...
        value: function value() {
          var e = this;
          a(c(t.prototype), "_init", this).call(this), d.each(m, function (t) {
            t.INIT && e[t.INIT]();
          });
        }
      }, {
        ...
        value: function value() {
          var e = this;
          a(c(t.prototype), "bindEvent", this).call(this), this.on("beforeitemactived", function (t) {
            var n = t.item,
    ...
    d.each(m, function (e) {
      d.mix(y.prototype, e.AUGMENT);
    }), l.setRegister(y, "diagram", "page"), e.exports = y;
  }, function (e, t) {
    e.exports = {
      gridStyle: {
        stroke: "#A3B1BF",
    ...
    var r = n(18);
    n(32), n(33), e.exports = r;
  }, function (e, t, n) {
    var r = n(13);
    n(75), n(80), e.exports = r;
  }, function (e, t, n) {
    function r(e) {
      return (r = "function" == typeof Symbol && "symbol" == (0, _typeof2["default"])(Symbol.iterator) ? function (e) {
        return (0, _typeof2["default"])(e);
    ...
    var s = n(1),
      ...
      function t(e) {
        ...
        return d.mix(!0, r, {}, e), (n = i(this, c(t).call(this, r))).isKoni = !0, n;
      }
      ...
      }]) && o(n.prototype, r), s && o(n, s), t;
    }();

    s.setRegister(f, "koni", "diagram"), e.exports = f;
  }, function (e, t, n) {
    function r(e) {
      for (var t = 1; t < arguments.length; t++) {
        var n = null != arguments[t] ? arguments[t] : {},
    ...
    function u(e) {
      ...
      this.snapShot = t.save(), this.selectedItems = t.getSelected().map(function (e) {
        return e.id;
    ...
    function s(e) {
      var t = e.getCurrentPage();
      t.read(this.snapShot), t.setSelected(this.selectedItems, !0);
    }
    ...
    function d(e) {
      var t = e.getCurrentPage();
      this.fromMode = t.getMode(), t.changeMode(this.toMode);
    }
    ...
    a.list = [], a.registerCommand = function (e, t, n) {
      if (a[e]) i.mix(a[e], t);else {
        var o = r({
        ...
        n && a[n] && (o = i.mix({}, a[n], t)), a[e] = o, a.list.push(o);
      }
    }, a.execute = function (e, t, n) {
      var r = i.mix(!0, {}, a[e], n),
          o = t.get("_command");
      return r.enable(t) && (r.init(), r.queue && (o.queue.splice(o.current, o.queue.length - o.current, r), o.current += 1), t.emit("beforecommandexecute", {
        command: r
      }), r.execute(t), t.emit("aftercommandexecute", {
        command: r
      }), t.setCommandDOMenable()), r;
      ...
      execute: function execute(e) {
        var t = this.copyNode,
            ...
            o = t.getModel(),
            a = i.clone(o);
        a.id = i.guid(), a.x = this.x, a.y = this.y;
        var c = r.add("node", a),
            u = r.add("edge", {
          source: o.id,
          target: a.id
        });
        1 === this.executeTimes && (this.addIds = [c.id, u.id], this.page = n);
      },
      back: function back() {
      ...
      execute: function execute(e) {
        ...
        1 === this.executeTimes && (this.addId = n.id, this.page = t);
      },
      back: function back() {
      ...
      execute: function execute(e) {
        ...
        1 === this.executeTimes && (this.originModel = i.getContrast(r.getModel(), this.updateModel), this.page = t), n.update(r, this.updateModel);
      },
      back: function back() {
        var e = this.page.getGraph(),
      ...
      execute: function execute(e) {
        var t = e.get("_command");
        t.queue[t.current].execute(e), t.current += 1;
      },
      ...
      execute: function execute(e) {
        ...
        n.executeTimes++, n.back(e), t.current -= 1;
      },
      ...
      method: function method(e) {
        ...
        n.clipboard = [], t.forEach(function (e) {
      ...
      method: function method(e) {
        ...
        t.clearSelected(), this.copyCenterBox = i.clone(o), this.pasteData = i.clone(r), this.contextmenuPoint = i.clone(a), r.forEach(function (e) {
          var n = e.model;
          n.x && (n.x += a.x - o.minX), n.y && (n.y += a.y - o.minY), t.add(e.type, n);
        });
      },
      back: s
      ...
      method: function method(e) {
        var t = e.getCurrentPage(),
            n = e.get("_command"),
            r = this.pasteData ? this.pasteData : h(n.clipboard);
        t.clearSelected(), this.pasteData = i.clone(r), r.forEach(function (e) {
          var n = e.model;
          n.x && (n.x += 10), n.y && (n.y += 10), t.add(e.type, n);
        });
      },
      back: s
      ...
      getDeleteItems: function getDeleteItems(e) {
        var t = e.getCurrentPage(),
            n = t.getGraph(),
    ...
    n.r(t), n.d(t, "mouseEnterEdge", function () {
      return o;
    ...
    function o(e) {
      var t = e.graph,
        ...
        y: o.y
          ...
          s = u.index,
          l = u.vertical;
      null != s && (i && (a._cursor = n.getGraph().getMouseEventWrapper().style.cursor), t.update(a, {
        hold: {
          index: s,
          vertical: l
        }
    ...
    function s(e, t, n) {
      ...
      return i >= 2 && (n ? Math.abs(a[i - 2].x - a[i].x) <= 3 && (r = [{
        ...
        x: a[i - 2].x,
        y: a[i + 1].y
      }], c.push(i - 1, i), o.hold.index = i - 2, o.controlPoints[i + 1].x = a[i - 2].x) : Math.abs(a[i - 2].y - a[i].y) <= 3 && (r = [{
        x: a[i - 2].x,
        y: a[i - 2].y
      }, {
        x: a[i + 1].x,
        y: a[i - 2].y
      }], c.push(i - 1, i), o.hold.index = i - 2, o.controlPoints[i + 1].y = a[i - 2].y)), i <= a.length - 4 && (n ? Math.abs(a[i].x - a[i + 2].x) <= 3 && (r ? (r[1] = {
        x: a[i - 2].x,
        y: a[i + 3].y
        ...
        x: a[i + 3].x,
        y: a[i + 3].y
      }], o.controlPoints[i].x = a[i + 3].x), c.push(i + 1, i + 2)) : Math.abs(a[i].y - a[i + 2].y) <= 3 && (r ? (r[1] = {
        x: a[i + 3].x,
        y: a[i - 2].y
        ...
        x: a[i + 3].x,
        y: a[i + 3].y
      }], o.controlPoints[i].y = a[i + 3].y), c.push(i + 1, i + 2))), c && c.length && a.splice(c[0], c.length), r;
    }
  }, function (e, t, n) {
    function r(e) {
      return (r = "function" == typeof Symbol && "symbol" == (0, _typeof2["default"])(Symbol.iterator) ? function (e) {
    ...
    var s = n(27),
      ...
      function t(e) {
        ...
        return n._cfg = l.mix(!0, {}, n._cfg, r, e), n;
      }
    ...
    e.exports = function (e) {
      ...
      getParallelEdges: function getParallelEdges(e, t) {
      ...
      object2array: function object2array(e) {
        var t = [];
    ...
    var u = n(9),
      ...
      return function (e, t) {
        ...
        value: function value() {
          ...
          return this.dom = e, e.isSatellite = !0, e;
        }
      }, {
        key: "getDOM",
        value: function value() {
        ...
        value: function value() {
          ...
          e && (e.css({
            position: "absolute",
            visibility: "hidden"
          }), t.appendChild(e), e && this.bindEvent(e, this.diagram));
        }
      }, {
        key: "enable",
        value: function value() {
    ...
    var u = n(21),
      ...
      return function (e, t) {
        ...
        value: function value(e) {
          ...
          s.each(e, function (e) {
            ...
            l[r] ? s.addEventListener(e, "click", function () {
              t.getCurrentPage().focusGraphWrapper(), t.executeCommand(r, n);
        ...
        value: function value(e) {
          var t = this;
          this.setCommandDOMenable(), e.on("statuschange", function (e) {
            ...
            var r = t.getComponentsByType("contextmenu"),
              ...
              y: n.y
                ...
                c = n.item;
            c && !c.isSelected && (e.clearSelected(), e.setSelected(n.item, !0)), t.set("contextmenuPoint", a), n.domEvent.preventDefault(), r.forEach(function (e) {
              e.show(), e.contextmenuPoint = a, e.move(i.left + n.domX, i.top + n.domY);
            });
        ...
        value: function value(e) {
          var t = e.getCommandDoms();
          e.bindEvent(), this._bindCommands(t);
        }
      }, {
        ...
        value: function value() {
          var e,
              t = this.getComponentsByType("page");
          return t.every(function (t) {
            return !t.isActived || (e = t, !1);
          }), e || (e = t[0]), e;
        }
      }, {
        key: "getComponents",
        ...
        value: function value(e) {
          ...
          e.getGraph().on("keydown", function (e) {
            ...
            for (var i = l.list.filter(function (e) {
              ...
              var c = i[a];
              if (t._shortcutEnable(c, o)) return t.executeCommand(c.name), !1;
            }
          });
        }
      }, {
        ...
        value: function value(e) {
          ...
          e.editor = this, this["_beforeAdd" + n] && this["_beforeAdd" + n](e), t.push(e), this["_afterAdd" + n] && this["_afterAdd" + n](e);
        }
      }, {
        key: "destroy",
        value: function value() {
    ...
    !function (t) {
      ...
      i.getListeners = function (e) {
        ...
        if (!function e(t) {
          return "function" == typeof t || t instanceof RegExp || !(!t || "object" != (0, _typeof2["default"])(t)) && e(t.listener);
        }(t)) throw new TypeError("listener must be a function");
        var n,
            r = this.getListenersAsObject(e),
            o = "object" == (0, _typeof2["default"])(t);
        ...
        return this;
      }, i.on = u("addListener"), i.addOnceListener = function (e, t) {
        return this.addListener(e, {
          listener: t,
          once: !0
        });
      }, i.once = u("addOnceListener"), i.defineEvent = function (e) {
        ...
        return this;
      }, i.off = u("removeListener"), i.addListeners = function (e, t) {
        ...
        if ("object" != (0, _typeof2["default"])(t) || t instanceof RegExp) for (r = n.length; r--;) {
          i.call(this, t, n[r]);
        } else for (r in t) {
        ...
        return this;
      }, i.removeAllListeners = u("removeEvent"), i.emitEvent = function (e, t) {
        var n,
            r,
            o,
            i,
        ...
        for (i in a) {
          if (a.hasOwnProperty(i)) for (n = a[i].slice(0), o = 0; o < n.length; o++) {
            !0 === (r = n[o]).once && this.removeListener(e, r.listener), r.listener.apply(this, t || []) === this._getOnceReturnValue() && this.removeListener(e, r.listener);
          }
        }

        return this;
      }, i.trigger = u("emitEvent"), i.emit = function (e) {
    ...
    Object.keys(a).forEach(function (e) {
      c[e] = (0, i["default"])(a[e]);
    }), t.generate = i["default"], t.presetPalettes = c, t.presetPrimaryColors = a;
  }, function (e, t, n) {
    "use strict";
    ...
    Object.defineProperty(t, "__esModule", {
      ...
      for (var t = [], n = (0, i["default"])(e), r = d; r > 0; r -= 1) {
        var o = n.toHsv(),
            a = (0, i["default"])({
          h: h(o, r, !0),
          s: g(o, r, !0),
    ...
    function g(e, t, n) {
      ...
      var r = void 0;
      return (r = n ? Math.round(100 * e.s) - c * t : t === f ? Math.round(100 * e.s) + c : Math.round(100 * e.s) + u * t) > 100 && (r = 100), n && t === d && r > 10 && (r = 10), r < 6 && (r = 6), r;
    }
    ...
    !function (o) {
      ...
      function f(e, t) {
        ...
        var n = function (e) {
          ...
          "object" == (0, _typeof2["default"])(e) && (H(e.r) && H(e.g) && H(e.b) ? (h = e.r, g = e.g, p = e.b, t = {
            r: 255 * X(h, 255),
            g: 255 * X(g, 255),
            b: 255 * X(p, 255)
          }, d = !0, f = "%" === String(e.r).substr(-1) ? "prgb" : "rgb") : H(e.h) && H(e.s) && H(e.v) ? (r = D(e.s), c = D(e.v), t = function (e, t, n) {
          ...
          }(e.h, r, c), d = !0, f = "hsv") : H(e.h) && H(e.s) && H(e.l) && (r = D(e.s), u = D(e.l), t = function (e, t, n) {
            var r, o, i;
            ...
            if (e = X(e, 360), t = X(t, 100), n = X(n, 100), 0 === t) r = o = i = n;else {
              var c = n < .5 ? n * (1 + t) : n + t - n * t,
                  u = 2 * n - c;
              r = a(u, c, e + 1 / 3), o = a(u, c, e), i = a(u, c, e - 1 / 3);
            }
            return {
              r: 255 * r,
              g: 255 * o,
        ...
        this._originalInput = e, this._r = n.r, this._g = n.g, this._b = n.b, this._a = n.a, this._roundA = u(100 * this._a) / 100, this._format = t.format || n.format, this._gradientType = t.gradientType, this._r < 1 && (this._r = u(this._r)), this._g < 1 && (this._g = u(this._g)), this._b < 1 && (this._b = u(this._b)), this._ok = n.ok, this._tc_id = c++;
      }
      ...
      function S(e, t) {
        t = 0 === t ? 0 : t || 10;
        var n = f(e).toRgb();
        return n.r = l(0, s(255, n.r - u(-t / 100 * 255))), n.g = l(0, s(255, n.g - u(-t / 100 * 255))), n.b = l(0, s(255, n.b - u(-t / 100 * 255))), f(n);
      }
      ...
      f.prototype = {
        ...
        for (var s = 0; s < t.length; s++) {
          (r = f.readability(e, t[s])) > u && (u = r, c = f(t[s]));
        }

        return f.isReadable(e, c, {
          level: i,
          size: a
        }) || !o ? c : (n.includeFallbackColors = !1, f.mostReadable(e, ["#fff", "#000"], n));
      };
      ...
      function X(e, t) {
        ...
        return e = s(t, l(0, parseFloat(e))), n && (e = parseInt(e * t, 10) / 100), o.abs(e - t) < 1e-6 ? 1 : e % t / parseFloat(t);
      }
      ...
      var N,
          F,
          R,
          z = (F = "[\\s|\\(]+(" + (N = "(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)") + ")[,|\\s]+(" + N + ")[,|\\s]+(" + N + ")\\s*\\)?", R = "[\\s|\\(]+(" + N + ")[,|\\s]+(" + N + ")[,|\\s]+(" + N + ")[,|\\s]+(" + N + ")\\s*\\)?", {
    ...
    function o(e) {
      var t = e.getCurrentPage();
      this.matrixCache = t.getMatrix().slice(0), this._zoom(e), t.updateStatus();
    }
    ...
    r.registerCommand("collapseExpand", {
      ...
      execute: function execute(e) {
        ...
        r.getModel().collapsed ? (n.update(r, {
          ...
          collapsed: !0
        }), this.toCollapsed = !0), t.clearSelected(), t.setSelected(r, !0), 1 === this.executeTimes && (this.itemId = r.id);
      },
      back: function back(e) {
        ...
        this.toCollapsed ? n.update(r, {
          ...
          collapsed: !0
        }), t.clearSelected(), t.setSelected(r, !0);
      },
      shortcutCodes: [["metaKey", "/"], ["ctrlKey", "/"]]
    ...
    i.AUGMENT = {
      ...
      add: function add(e, t) {
        return this.get("_graph").add(e, t), this;
      },
      focusPointByDom: function focusPointByDom(e) {
        return this.get("_graph").focusPointByDom(e), this;
      },
      focusPoint: function focusPoint(e) {
        return this.get("_graph").focusPoint(e), this;
      },
      ...
      remove: function remove(e) {
        return this.get("_graph").remove(e), this;
      },
      update: function update(e, t) {
        return this.get("_graph").update(e, t), this;
      },
      zoom: function zoom(e, t) {
        return this.get("_graph").zoom(e, t), this;
      },
      getDomPoint: function getDomPoint(e) {
        return this.get("_graph").getDomPoint(e);
      },
      getPoint: function getPoint(e) {
        return this.get("_graph").getPoint(e);
      },
      zoomByDom: function zoomByDom(e, t) {
        var n = this.get("_graph"),
            r = n.getPoint(e);
        return n.zoom(r, t), this;
      },
      ...
      setCapture: function setCapture(e) {
    ...
    a.AUGMENT = {
      ...
      showGrid: function showGrid(e) {
        ...
        n || (e ? i.isObject(e) && this.set("grid", e) : this.set("grid", !0), this._initGrid()), (n = this.getController("grid")).show(), t.draw();
      },
    ...
    var u = n(9),
      ...
      return function (e, t) {
        ...
        value: function value() {
          ...
          "point" === i && (r.lineDash = null), r.lineWidth = a, r.path = t;
          var c = n.addShape("path", {
            attrs: r,
            capture: !1,
            zIndex: 0
          });
          l.toBack(c, n), this.gridEl = c;
        }
      }, {
        key: "show",
        value: function value() {
        ...
        value: function value() {
          for (var e = this.graph, t = e.get("width"), n = e.get("height"), r = e.getPoint({
            ...
            var l = a + s;
            u.push(["M", l, r.y]), u.push(["L", l, o.y]);
          }

          for (var d = 0; d <= o.y - r.y; d += i) {
            var f = c + d;
            u.push(["M", r.x, f]), u.push(["L", o.x, f]);
          }
        ...
        value: function value(e) {
          ...
          n.attr("lineWidth", o), n.attr("path", t);
        }
      }, {
        key: "destroy",
        value: function value() {
    ...
    n.INIT = "_initEvent", n.AUGMENT = {
      _initEvent: function _initEvent() {
        var e = this,
            t = this.get("_graph");
        r(t, this, "click"), r(t, this, "dblclick"), r(t, this, "mouseenter"), r(t, this, "mouseleave"), r(t, this, "mousedown"), r(t, this, "mouseup"), r(t, this, "contextmenu"), t.on("keydown", function (t) {
          e.emit("keydown", t);
          ...
          e.emit("afterviewportchange", t), t.updateMatrix[0] !== t.originMatrix[0] && e.emit("afterzoom", t);
        }), t.on("beforeviewportchange", function (t) {
          e.emit("beforeviewportchange", t), t.updateMatrix[0] !== t.originMatrix[0] && e.emit("beforezoom", t);
        });
      }
    }, e.exports = n;
  }, function (e, t, n) {
    ...
    o.AUGMENT = {
      ...
      setItemSelected: function setItemSelected(e) {
        var t = this.get("_graph").getShapeObj(e).getSelectedStyle(e),
            n = e.getKeyShape();
        this.get("_selectedCache")[e.id] = e, t && n.attr(t), e.isEdge && (e.startArrow && e.startArrow.attr({
          fill: t.stroke
        }), e.endArrow && e.endArrow.attr({
          fill: t.stroke
        }));
      },
      clearItemSelected: function clearItemSelected(e) {
        var t = this.get("_graph"),
            n = e.getKeyShape(),
            o = t.getShapeObj(e),
            i = o.getStyle(e),
            ...
            u = r.getContrast(i, a);
        n.attr(u), e.isEdge && (e.startArrow && e.startArrow.attr({
          fill: u.stroke
        }), e.endArrow && e.endArrow.attr({
          fill: u.stroke
        })), delete c[e.id];
      ...
      setSelected: function setSelected(e, t) {
        var n,
            o = this,
            i = this.get("selectable"),
            a = this.get("_graph");
        i && (n = r.isArray(e) ? e : [e], r.each(n, function (e) {
          r.isString(e) && (e = a.find(e)), e && !e.destroyed && (t ? (o.emit("beforeitemselected", {
            item: e
          }), o.setItemSelected(e), o.emit("afteritemselected", {
            item: e
          })) : (o.emit("beforeitemunselected", {
            item: e
          }), o.clearItemSelected(e), o.emit("afteritemunselected", {
            item: e
          })), e.isSelected = t, o.updateStatus(), a.draw());
        }));
      },
    ...
    o.AUGMENT = {
      ...
      setItemActived: function setItemActived(e) {
        var t = this.get("_graph").getShapeObj(e),
            n = this.get("_activedCache"),
            r = t.getActivedStyle(e),
            o = e.getKeyShape();
        n[e.id] = e, r && o.attr(r), e.isEdge && (e.startArrow && e.startArrow.attr({
          fill: r.stroke
        }), e.endArrow && e.endArrow.attr({
          fill: r.stroke
        }));
      },
      clearItemActived: function clearItemActived(e) {
        var t = this.get("_graph"),
            n = e.getKeyShape(),
            o = t.getShapeObj(e),
            i = o.getStyle(e),
      ...
      setActived: function setActived(e, t) {
        var n,
            o = this,
            i = this.get("activeable"),
            a = this.get("_graph");
        i && (n = r.isArray(e) ? e : [e], r.each(n, function (e) {
          r.isString(e) && (e = a.find(e)), e && !e.destroyed && (t ? (o.emit("beforeitemactived", {
            item: e
          }), o.setItemActived(e), o.emit("afteritemactived", {
            item: e
          })) : (o.emit("beforeitemunactived", {
            item: e
          }), o.clearItemActived(e), o.emit("afteritemunactived", {
            item: e
          })), e.isActived = t);
        }), a.draw());
      },
      ...
      return function (e, t) {
        ...
        value: function value() {
          ...
          e.on("afteritemdraw", function (e) {
            ...
            if (!l.isEdge(o)) {
              var i = o.getBBox();
              !0 === r || "horizontal" === r ? (t[o.id + "tltr"] = [i.minX, i.minY, i.maxX, i.minY, o], t[o.id + "lcrc"] = [i.minX, i.centerY, i.maxX, i.centerY, o], t[o.id + "blbr"] = [i.minX, i.maxY, i.maxX, i.maxY, o]) : "center" === r && (t[o.id + "lcrc"] = [i.minX, i.centerY, i.maxX, i.centerY, o]), !0 === r || "vertical" === r ? (n[o.id + "tlbl"] = [i.minX, i.minY, i.minX, i.maxY, o], n[o.id + "tcbc"] = [i.centerX, i.minY, i.centerX, i.maxY, o], n[o.id + "trbr"] = [i.maxX, i.minY, i.maxX, i.maxY, o]) : "center" === r && (n[o.id + "tcbc"] = [i.centerX, i.minY, i.centerX, i.maxY, o]);
            }
          }), e.on("beforeitemdestroy", function (e) {
            var r = e.item;
            delete t[r.id + "tltr"], delete t[r.id + "lcrc"], delete t[r.id + "blbr"], delete n[r.id + "tlbl"], delete n[r.id + "tcbc"], delete n[r.id + "trbr"];
          });
        }
      }, {
        key: "align",
        value: function value(e, t) {
          ...
          return this.grid && r && r.visible && this._gridAlign(e, t), this.item && this._itemAlign(e, t, n), e;
        }
      }, {
        key: "_gridAlign",
        value: function value(e, t) {
          ...
          if ("cc" === r) {
            ...
            e.x = i - t.width / 2, e.y = a - t.height / 2;
          } else e.x = Math.round(e.x / o) * o, e.y = Math.round(e.y / o) * o;
        }
      }, {
        key: "_itemAlign",
        value: function value(e, t, n) {
          ...
          if (this.clearAlignLine(), l.each(r, function (e) {
            e[4].isVisible() && (h.push(d(e, a)), h.push(d(e, c)), h.push(d(e, u)));
          }), l.each(o, function (e) {
            e[4].isVisible() && (g.push(d(e, s)), g.push(d(e, c)), g.push(d(e, f)));
          }), h.sort(function (e, t) {
            return e.dis - t.dis;
          }), g.sort(function (e, t) {
            return e.dis - t.dis;
          }), 0 !== h.length && h[0].dis < i) {
            e.y = h[0].line[1] - h[0].point.y + n.y, p = {
              type: "item",
              horizontals: [h[0]]
            };
          ...
          if (0 !== g.length && g[0].dis < i) {
            e.x = g[0].line[0] - g[0].point.x + n.x, p ? p.verticals = [g[0]] : p = {
              type: "item",
              verticals: [g[0]]
            };
          ...
          p && (p.bbox = t, this._addAlignLine(p));
        }
      }, {
        key: "clearAlignLine",
        value: function value() {
        ...
        value: function value(e) {
          ...
          "item" === e.type && (e.horizontals && l.each(e.horizontals, function (e) {
            var i,
                ...
                u = e.point,
                s = (c[0] + c[2]) / 2;
            u.x < s ? (i = u.x - t.width / 2, a = Math.max(c[0], c[2])) : (i = u.x + t.width / 2, a = Math.min(c[0], c[2]));
            ...
            var i,
                ...
                u = e.point,
                s = (c[1] + c[3]) / 2;
            u.y < s ? (i = u.y - t.height / 2, a = Math.max(c[1], c[3])) : (i = u.y + t.height / 2, a = Math.min(c[1], c[3]));
            var d = n.addShape("line", {
              attrs: l.mix({
                x1: c[0],
                y1: i,
    ...
    o.AUGMENT = {
      _initLabelEditor: function _initLabelEditor() {
        ...
        if (this.get("labelEditable")) {
          ...
          t.getGraphContainer().appendChild(n), n.on("blur", function (n) {
            n.stopPropagation(), !t.destroyed && e.endEditLabel();
          }), n.on("keydown", function (t) {
            t.stopPropagation();
            var n = r.getKeyboradKey(t);
            (t.metaKey && "s" === n || t.ctrlKey && "s" === n) && t.preventDefault(), "Enter" !== n && "Escape" !== n || e.endEditLabel();
          }), this.set("labelTextArea", n), t.on("beforeviewportchange", function () {
            n.focusItem && e.setLabelEditorBeginPosition(n.focusItem);
          });
        }
      },
      _getLabelTextAreaBox: function _getLabelTextAreaBox(e, t) {
      ...
      setLabelEditorBeginPosition: function setLabelEditorBeginPosition(e) {
      ...
      beginEditLabel: function beginEditLabel(e) {
        var t = this.get("labelTextArea"),
            n = this.getGraph();

        if (r.isString(e) && (e = n.find(e)), e && !e.destroyed && t) {
          ...
          if (t.focusItem = e, i) {
            ...
            t.innerHTML = o.label, t.innerHTML = o.label, t.css({
              "min-width": s + "px",
              "min-height": l + "px",
              visibility: "visible",
          ...
          } else t.innerHTML = "", t.css({
            "min-width": "auto",
            "min-height": "auto"
          });

          this.setLabelEditorBeginPosition(e), t.css({
            visibility: "visible"
          }), t.focus(), document.execCommand("selectAll", !1, null);
        }
      },
      endEditLabel: function endEditLabel() {
        var e = this.get("labelTextArea");

        if (this.setSignal("preventWheelPan", !1), e) {
          var t = e.focusItem;
          ...
          if (t) {
            ...
            }), e.hide(), e.focusItem = void 0, this.focusGraphWrapper();
          }
        }
      }
    }, e.exports = o;
    ...
    var n = {
      AUGMENT: {
        updateStatus: function updateStatus() {
          var e,
              t = this.getSelected();
          0 === t.length ? e = "canvas-selected" : 1 === t.length ? t[0].isNode ? e = "node-selected" : t[0].isEdge ? e = "edge-selected" : t[0].isGroup && (e = "group-selected") : e = "multi-selected", this.emit("statuschange", {
            status: e
          });
        }
      }
    ...
    n(45), n(46), n(47), n(48), n(49), n(50), n(51), n(52), n(53), n(54), n(55), n(56), n(57), n(58), n(59), n(60), n(61), n(62);
  }, function (e, t, n) {
    var r = n(3),
        o = n(4);
    ...
    r.registerBehaviour("wheelChangeViewport", function (e) {
      ...
      n.behaviourOn("wheel", function (e) {
        ...
        if (e.getSignal("preventWheelPan")) return;
        var a = r.domEvent,
        ...
        if (c) {
          ...
          var l = [],
              d = n.getMatrix();
          i.mat3.translate(l, d, [a.wheelDeltaX * o.wheelPanRatio, a.wheelDeltaY * o.wheelPanRatio]), e.translateLimt(l) && n.updateMatrix(l);
        }

        t && clearTimeout(t), t = setTimeout(function () {
          e.setCapture(!0), t = void 0;
        }, 50);
      }, 16));
    });
  }, function (e, t, n) {
        ...
        if (2 !== r.button && r.item && (r.item.isNode || r.item.isGroup)) {
          ...
          if ((o = (o = i.isSelected ? e.getSelected() : [i]).filter(function (e) {
            ...
            var a = e.getDelegation(o, n),
                c = a.getBBox();
            e.setSignal("panningItem", !0), e.set("panItems", o), e.set("panItemDelegation", a), e.set("panItemStartBox", c), e.set("panItemStartPoint", {
              x: r.x,
              y: r.y
            }), t.draw();
          }
    ...
    n(3).registerBehaviour("endPanItem", function (e) {
      ...
      t.behaviourOn("panitemend", function () {
        ...
        n && (n.remove(), t.draw()), e.setSignal("panningItem", !1), e.set("panItemDelegation", void 0), e.set("panItemStartPoint", void 0), e.set("panItemStartBox", void 0), e.set("panItems", void 0);
      }), t.behaviourOn("canvas:mouseleave", function () {
        e.get("panItems") && (e.clearAlignLine(), t.emit("panitemend"));
      });
    });
  }, function (e, t, n) {
    ...
    n(3).registerBehaviour("clickCanvasSelected", function (e) {
      ...
      t.behaviourOn("click", function (t) {
        t.shape || (e.clearSelected(), e.clearActived(), e.updateStatus());
    ...
    n(3).registerBehaviour("clickEdgeSelected", function (e) {
      e.getGraph().behaviourOn("edge:click", function (t) {
        e.get("multiSelectable") && !0 === e.getSignal("shiftKeyDown") ? e.setSelected(t.item.id, !0) : (e.clearActived(), e.clearSelected(), e.setSelected(t.item.id, !0));
      });
    });
  }, function (e, t, n) {
    ...
    n(3).registerBehaviour("hoverNodeActived", function (e) {
      ...
      n.behaviourOn("node:mouseenter", function (n) {
        !1 !== n.item.getShapeObj().panAble && e.css({
          cursor: "move"
        }), e.getSignal("panningItem") || e.getSignal("dragEdge") || n.item && n.item.isSelected || (t = n.item, e.setActived(t, !0));
      }), n.behaviourOn("node:mouseleave", function (n) {
        var r = n.toShape;
        t && (r && r.isAnchor && r.getItem() === t || e.getSignal("dragEdge") || (t.isSelected || e.setActived(t, !1), t = void 0));
      });
    });
  }, function (e, t, n) {
    ...
    var r = n(22);
    e.exports = {
      dragingEdgeEndPoint: function dragingEdgeEndPoint(e) {
        ...
        o.attr("path", d), r.draw();
      },
      panGroup: function panGroup(e, t, n, o) {
        var i = e.getModel();
      ...
      dropUpdateEdge: function dropUpdateEdge(e) {
        var t = e.ev,
            n = e.endPointType,
            r = e.model,
            o = e.diagram,
        ...
        if (o.getGraph().emit("beforedropedge"), s) {
          if (a && s.isAnchor && s.hasHotspot) {
            var f = s,
                h = f.getItem();
            return "target" === n ? (r.target = h.id, r.targetAnchor = f.getIndex(), !0) : (r.source = h.id, r.sourceAnchor = f.getIndex(), !0);
          }

          if (c && u && u.isNode) return "target" === n ? (r.target = u.id, !0) : (r.source = u.id, !0);
        } else if (i) return "target" === n ? (r.target = {
          x: l,
          y: d
        }, !0) : (r.source = {
          x: l,
    ...
    e.exports = {
      rectRectCrossAlgorithm: function rectRectCrossAlgorithm(e, t) {
      ...
      euclideanDistance: {
        pointPoint: function pointPoint(e, t) {
    ...
    var r = {},
        o = n(2);
    r.AUGMENT = {
      changeAddEdgeModel: function changeAddEdgeModel(e) {
        this.set("addEdgeModel", e);
      },
      cancelAdd: function cancelAdd() {
        this.set("addType", void 0), this.set("addModel", void 0), this.changeMode("default");
      },
      beginAdd: function beginAdd(e, t) {
        this.set("addType", e), this.set("addModel", t), this.changeMode("add");
      },
      ...
      addGroup: function addGroup(e) {
        ...
        if (0 !== r.length) {
          e || (e = {
            label: "新建分组"
          }), o.setId(e), n.add("group", e), n.toFront(e.id);
          var a = n.find(e.id);
          ...
          if (r.forEach(function (e) {
            ...
            t && (e.parent = t.getModel().id), r.forEach(function (t) {
              n.update(t, {
                parent: e.id
              });
            });
      ...
      unGroup: function unGroup() {
        ...
        1 === t.length && o.isGroup(n) && (n.getChildren().forEach(function (t) {
          e.update(t, {
            parent: void 0
          }), t.collapsedParent || t.show(), t.isGroup && t.deepEach(function (e) {
            e.collapsedParent || e.show();
          });
        }), e.remove(n));
      },
      newGroup: function newGroup(e) {
        this.addGroup(e);
      }
    }, e.exports = r;
  }, function (e, t, n) {
    ...
    a.AUGMENT = {
      ...
      showAnchor: function showAnchor(e, t, n) {
        this.getController("anchor").showAnchor(e, t, n);
      },
      clearAnchor: function clearAnchor(e) {
        this.getController("anchor").clearAnchor(e);
      },
      setHotspotActived: function setHotspotActived(e, t) {
        this.getController("anchor").setHotspotActived(e, t);
      },
      hoverShowAnchor: function hoverShowAnchor(e) {
        var t = this,
            n = e.getAnchorPoints(),
            r = [];
        n.forEach(function (n, o) {
          ...
          t.emit("hovernode:beforeshowanchor", i), i.cancel || r.push(o);
        }), this.showAnchor(e, r);
      },
      anchorHasBeenLinked: function anchorHasBeenLinked(e, t) {
        var n = e.getEdges(),
            r = [];
        return n.forEach(function (t) {
          var n = t.getModel();
          n.source !== e.id || i.isNil(n.sourceAnchor) || r.push(n.sourceAnchor), n.target !== e.id || i.isNil(n.targetAnchor) || r.push(n.targetAnchor);
        }), i.isObject(t) ? -1 !== r.indexOf(t.index) : -1 !== r.indexOf(t);
      },
      dragEdgeBeforeShowAnchor: function dragEdgeBeforeShowAnchor(e, t, n) {
        var r = this;
          ...
          if (e.isNode) {
            ...
            c.forEach(function (c, s) {
              i = "target" === n ? {
                ...
                sourceAnchor: c,
                dragEndPointType: n
              }, r.emit("dragedge:beforeshowanchor", i), i.cancel || a.push(s);
            });
          } else c.forEach(function (e, t) {
            a.push(t);
          });
    ...
    var l = n(9),
      ...
      return function (e, t) {
        ...
        value: function value(e, t, n, r) {
          ...
          this._clearAnchor(e), f.each(i, function (i, a) {
            if (!n || -1 !== n.indexOf(a)) {
              var c,
                  u = t.addShape("marker", {
                attrs: o({
              ...
              u.toFront(), u.eventPreFix = "anchor", u.showHotspot = function () {
                c = t.addShape("marker", {
                  attrs: o({
                    symbol: "circle"
                ...
                }), e.anchorShapes.push(c), u.hasHotspot = !0, c.toFront(), u.toFront();
              }, u.getIndex = function () {
                return a;
              }, u.getItem = function () {
                return e;
              ...
              }, u.isAnchor = !0, u.setHotspotActived = function (e) {
                c && (e ? c.attr(d.anchorHotsoptActivedStyle) : c.attr(d.anchorHotsoptStyle));
              }, r && u.showHotspot(), e.anchorShapes.push(u), e.getAllAnchors = function () {
        ...
        value: function value(e, t, n) {
          if (e.isVisible()) {
            var r = this.graph,
                ...
                i = r.getRootGroup();
            this._drawAnchor(e, i, t, n), e.isAnchorShow = !0, o[e.id] = e;
          }
        }
      }, {
        key: "clearAnchor",
        value: function value(e) {
          var t = this,
              ...
              o = this._anchorItemCache,
              i = e;
          i = f.isObject(e) ? [e] : f.isString(e) ? [r[e]] : o, f.each(i, function (e) {
            t._clearAnchor(e), e.isAnchorShow = !1, delete o[e.id];
          }), n.draw();
        }
      }]) && a(n.prototype, r), i && a(n, i), t;
    }();
    ...
    i.AUGMENT = {
      _initOrbit: function _initOrbit() {
    ...
    var s = n(9),
      ...
      function t() {
        return function (e, t) {
          if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
        }(this, t), a(this, c(t).apply(this, arguments));
      }
      ...
      return function (e, t) {
        ...
        value: function value() {
          ...
          n.getGraph().addBehaviour("orbit"), t.forEach(function (t) {
      ...
      }]) && i(n.prototype, r), f && i(n, f), t;
    }();

    e.exports = p;
  }, function (e, t, n) {
    var r = n(23);
    r.forkAndLink = n(71), e.exports = r;
  }, function (e, t, n) {
    function r(e) {
      return (r = "function" == typeof Symbol && "symbol" == (0, _typeof2["default"])(Symbol.iterator) ? function (e) {
        return (0, _typeof2["default"])(e);
          ...
          return {
            ...
            bindEvent: function bindEvent(e, t) {
              var n = this,
                  r = t.getGraph(),
                  i = r.getRootGroup();
              return e.setAttribute("draggable", "true"), [l.addEventListener(e, "dragstart", function () {
                var r = n.item,
                    a = function (e) {
                  for (var t = 1; t < arguments.length; t++) {
                    var n = null != arguments[t] ? arguments[t] : {},
                ...
                t.setSignal("dragEdge", !0), t.beginAdd("edge", a), t.set("addEdgeConfig", {
                  addModel: a,
                  delegation: u,
                  startPoint: {
                    x: c.centerX,
                ...
                var o = e.clientX,
                  ...
                  y: i
                    ...
                    h = l.vec2.length(f);
                if (l.vec2.scale(f, f, 160 / h), a) a.executeCommand("copyAdjacent", {
                  copyNode: c,
                  x: u.x + f[0],
                  y: u.y + f[1]
                });else {
                  var g = l.clone(d);
                  g.x = u.x + f[0], g.y = u.y + f[1], r.add(c.type, g);
                }
              })];
            }
          };
        }
      }]) && i(n.prototype, r), d && i(n, d), t;
    }();
    ...
    function a(e) {
      e.controlPointShapes && r.each(e.controlPointShapes, function (e) {
        e.remove();
      }), e.controlPointShapes = [], e.isControlPointShow = !1;
    }

    i.INIT = "_initResize", i.CFG = {
      nodeResizeable: !1,
      edgeResizeable: !0
    }, i.AUGMENT = {
      ...
      drawControlPoints: function drawControlPoints(e) {
        var t,
            n,
            i,
            c,
            ...
            d,
            f,
            h = this.get("_graph").getRootGroup(),
            g = this.get("nodeResizeable"),
            p = this.get("edgeResizeable");
        "node" === e.type ? g && function (e, t) {
          ...
          e.controlPointShapes.push(c), r.each(i, function (n) {
        ...
        }(e, h) : "edge" === e.type && p && (n = h, i = (t = e).getKeyShape().attr("path"), c = i[0], u = c.length, s = i[i.length - 1], l = s.length, d = [{
          x: c[u - 2],
          y: c[u - 1]
        }, {
          x: s[l - 2],
          y: s[l - 1]
        }], f = t.getModel(), a(t), r.each(d, function (e, i) {
    ...
    var i = n(2),
        a = {};
    a.AUGMENT = {
      addOutterShape: function addOutterShape(e, t) {
        ...
        var n = t.lineWidth,
            ...
            s = o.attr("lineWidth"),
            l = i.clone(c);
        delete l.fillStyle, delete l.strokeStyle, delete l.matrix;
        var d = a.addShape(u, {
          attrs: r({}, l, {
            fill: null
          }, t)
        ...
        var f = d.getBBox(),
            ...
            p = (f.minX + f.maxX) / 2,
            m = (f.minY + f.maxY) / 2;
        d.transform([["t", -p, -m], ["s", (n + h + s) / h, (n + g + s) / g], ["t", p, m]]), d.isOutter = !0, e.outterShape = d;
      },
      clearOutterShape: function clearOutterShape(e) {
      ...
      AUGMENT: {
        _initLink: function _initLink() {
          ...
          n && (this.on("beforeitemactived", function (t) {
            ...
            var n = t.item;
            (n.isNode || n.isGroup) && e.clearAnchor(n);
          }), t.addBehaviour("dragAnchorAddEdge", "add"), t.addBehaviour("hoverAnchorActived", "default"), t.changeMode(o)), r && (t.addBehaviour("hoverNodeAddOutter", "add"), t.addBehaviour("hoverNodeAddOutter", "default"), t.changeMode(o));
        }
      }
    };
    e.exports = n;
    ...
    i.registerNode("diagram-base", {
      ...
      getDefaulStyle: function getDefaulStyle() {
        return c.nodeStyle;
      },
      getDefaulActivedStyle: function getDefaulActivedStyle() {
        return c.nodeActivedStyle;
      },
      getDefaulSelectedtyle: function getDefaulSelectedtyle() {
      ...
      getStyle: function getStyle(e) {
        ...
        if (o) {
          ...
          t = i[this.defaultFillPalette], n = i[this.defaultStrokePalette];
        }
      ...
      getActivedStyle: function getActivedStyle(e) {
        var t = e.getModel(),
      ...
      getSelectedStyle: function getSelectedStyle(e) {
        var t = e.getModel(),
      ...
      getSelectedOutterStyle: function getSelectedOutterStyle(e) {
    ...
    r.registerEdge("diagram-base", {
      ...
      getPathByPoints: function getPathByPoints(e) {
        var t = e.points;
      ...
      getActivedOutterStyle: function getActivedOutterStyle() {},
      getSelectedOutterStyle: function getSelectedOutterStyle() {}
    });
  }, function (e, t, n) {
    function r(e) {
      for (var t = 1; t < arguments.length; t++) {
    ...
    i.registerGroup("diagram-base", {
      draw: function draw(e) {
        ...
        if (o.minX === 1 / 0 && (o.minX = t.x, o.maxX = t.x + O, o.minY = t.y, o.maxY = t.y + P), a && (o.minX = o.maxX - O, o.maxY = o.minY + P), o.maxX - o.minX < O) {
          var _ = O - o.maxX + o.minX;

          o.minX -= _ / 2, o.maxX += _ / 2;
        }
        ...
        return function (e, t, n, r) {
          ...
          c.isString(e) ? o.text = e : c.mix(o, e), t.addShape("text", {
            attrs: o
          });
        }(c.isNil(t.label) ? "新建分组" : t.label, n, C, E), function (e, t, n, o) {
          var i = t.addShape("path", {
            attrs: r({
              path: e
            }, d)
        ...
        }(c.isNil(t.icon) ? u : t.icon, n, C, E), function (e, t, n, o, i) {
          var a;
          ...
          if (e) {
            var c = (a = t.addShape("path", {
              attrs: r({
                ...
                u = c.maxX - c.minX;
            a.isExpandedButton = !0, a.translate(n + i - c.minX - u - x, o - c.minY + b);
          } else {
            var d = (a = t.addShape("path", {
              attrs: r({
                ...
                g = d.maxX - d.minX;
            a.isCollapsedButton = !0, a.translate(n + i - d.minX - g - x, o - d.minY + b);
          }

          return a.isButton = !0, a;
        }(a, n, C, E, k).item = e, t.x = o.minX, t.y = o.minY, M;
      },
      getStyle: function getStyle(e) {
        var t = e.getModel();
        return c.mix(!0, {}, p, {
    ...
    n(81), n(82), n(83), n(84), n(85), n(86), n(87), n(88), n(89), n(90), n(91), n(92), n(93), n(94);
  }, function (e, t, n) {
    var r = n(1),
        o = n(2);
    r.registerBehaviour("panItem", function (e) {
      ...
      t.behaviourOn("drop", function () {
        ...
        if (n) {
          ...
          var d = e.editor;
          t.emit("panitemend"), !d || e.getSignal("dragaddnodetogroup") ? f() : d.executeCommand(f);
        }
        ...
        function f() {
          ...
          }), 1 === i.length && (e.clearSelected(), e.setSelected(u, !0));
        }
      });
    ...
    o.registerBehaviour("hoverAnchorActived", function (e) {
      ...
      t.behaviourOn("anchor:mouseenter", function (n) {
        if (!e.getSignal("panningItem") && !e.getSignal("dragEdge")) {
          ...
          e.emit("hoveranchor:beforeaddedge", s), s.cancel ? e.css({
            cursor: i.cursor.hoverUnEffectiveAnchor
          }) : (e.css({
            cursor: i.cursor.hoverEffectiveAnchor
          }), !o.get("destroyed") && o.setActived(), e.beginAdd("edge", u), t.draw());
        }
        ...
        if (!e.getSignal("dragEdge") && !e.getSignal("panningItem")) {
          ...
          e.css({
            cursor: i.cursor.beforePanCanvas
          }), o.isSelected || (e.clearAnchor(o), e.setActived(o, !1)), !r.get("destroyed") && r.clearActived(), e.cancelAdd(), t.draw();
        }
      });
    });
  }, function (e, t, n) {
    ...
    r.registerBehaviour("dragEdgeControlPoint", function (e) {
      ...
      function p(g) {
        if (r) {
          ...
          e.setSignal("dragEdge", !1), t = void 0, n = void 0, r = void 0, a = void 0, c = void 0, u = void 0, s = void 0, l = void 0, d = void 0, f = void 0;
        }
      }
      ...
      h.behaviourOn("edgeControlPoint:mousedown", function (o) {
        if (2 !== o.button) {
          var i = o.shape;
          i.isTargetEndPoint() ? (d = i.getItem(), f = d.getModel(), t = i, a = i.getSourcePoint(), c = d.getSource(), s = f.sourceAnchor) : i.isSourceEndPoint() && (d = i.getItem(), f = d.getModel(), n = i, a = i.getTargetPoint(), u = d.getTarget(), l = f.targetAnchor), d && (r = e.getDelegation([d], g), c ? e.dragEdgeBeforeShowAnchor(c, s, "target") : u && e.dragEdgeBeforeShowAnchor(u, l, "source"), h.hide(d), e.setSignal("dragEdge", !0));
        }
      ...
      }), h.behaviourOn("mouseup", p), h.behaviourOn("canvas:mouseleave", p);
    ...
    r.registerBehaviour("dragPanelItemAddNode", function (e) {
      ...
      function s() {
        e.setSignal("panningItem", !1), e.set("panItemDelegation", void 0), e.set("panItemStartBox", void 0), e.set("panItemStartPoint", void 0), n = void 0, r = void 0, i = void 0, a = void 0;
      }

      c.behaviourOn("canvas:mouseenter", function (c) {
        if (!n && (i = e.get("addType"), a = e.get("addModel"), a = o.clone(a), "node" === i)) {
          ...
          t = {
            ...
            width: r[0],
            height: r[1]
          }, n = e.getDelegation([t], u), e.setSignal("panningItem", !0), e.set("panItemDelegation", n), e.set("panItemStartBox", t), e.set("panItemStartPoint", {
            x: c.x,
            y: c.y
          });
        }
        ...
        if (n) {
          ...
          o.setId(a);
          var u = e.editor;
          n.remove(), e.endAdd(), e.clearAlignLine(), e.clearSelected(), e.focusGraphWrapper(), u ? u.executeCommand("add", {
            type: "node",
            addModel: a
          }) : c.add(r, a), e.setSelected(c.find(a.id), !0), s();
        }
      }), c.behaviourOn("canvas:mouseleave", function () {
        n && (e.clearAlignLine(), n.remove(), c.draw(), e.cancelAdd(), s());
      });
    }, ["processPanItem"]);
  }, function (e, t, n) {
      ...
      t.behaviourOn("anchor:dragstart", function (t) {
        if (2 !== t.button) {
          var r = t.shape,
              ...
              u = r.getIndex();
          c.source = a.id, c.sourceAnchor = u;
          var s = {
            x: i.x,
            y: i.y
          },
          ...
          e.setSignal("dragEdge", !0), e.dragEdgeBeforeShowAnchor(a, u, "target"), e.set("addEdgeConfig", {
            addModel: c,
            delegation: l,
            startPoint: s,
            sourceItem: a
        ...
        if (n) {
          var t = r.getNodes().map(function (e) {
            return e.id;
              ...
              o = n.getBBox(),
              i = e.editor;
          i ? i.executeCommand(c) : c(), n.remove(), e.changeMode("default"), e.updateStatus(), r.draw(), a();
        }

        function c() {
          e.clearSelected(), t.forEach(function (t) {
            var n = r.find(t),
                i = n.getBBox();
    ...
    r.registerBehaviour("dragNodeAddToGroup", function (e) {
      ...
      function i() {
        e.setSignal("dragaddnodetogroup", !1), t = void 0, n = void 0;
      }

      r.behaviourOn("dragenter", function (i) {
        if (e.getSignal("panningItem")) {
          var a = e.get("panItems");
          a[0] && a[0].isNode && 1 === a.length && i.item && i.item.isGroup && a[0].getParent() !== i.item && (t = a[0], n = i.item, r.update(n, {
    ...
    r.registerBehaviour("dragOutFromGroup", function (e) {
      ...
      function u() {
        clearTimeout(r), n && a.update(n, {
          padding: void 0,
          style: void 0
        }), c = !1, t = void 0, n = void 0;
      }

      a.behaviourOn("drag", function (u) {
        e.getSignal("panningItem") && !c && (clearTimeout(r), r = setTimeout(function () {
          var r = e.get("panItems");

          if (r) {
            if (t = r[0], n = r[0].getParent(), t && 1 === r.length && n && !u.shape) {
    ...
    r.registerBehaviour("processAddEdge", function (e) {
      ...
      function n() {
        e.setSignal("dragEdge", !1), e.set("addEdgeConfig", {
          addModel: void 0,
          delegation: void 0,
          startPoint: void 0,
          sourceItem: void 0
      ...
      t.behaviourOn("mousemove", function (n) {
        ...
        if (a) {
          var c = a.addModel,
              ...
              s = a.sourceItem,
              l = e.editor;
          if (u) t.getNodes().forEach(function (t) {
            e.clearAnchor(t);
          }), e.clearAnchor(s), e.setActived(s, !1), e.setSelected(s, !1), e.css({
            cursor: i.cursor.beforePanCanvas
          }), u.remove(), o.dropUpdateEdge({
            ev: r,
            endPointType: "target",
            model: c,
            diagram: e
            ...
            type: "edge",
            addModel: c
          }) : t.add("edge", c)), t.draw(), e.endAdd(), n();else n();
        }
      }), t.behaviourOn("canvas:mouseleave", function () {
        var r = e.get("addEdgeConfig");
        ...
        if (r) {
          var o = r.delegation,
              i = r.sourceItem;
          if (o) t.getNodes().forEach(function (t) {
            e.clearAnchor(t);
          }), e.setActived(i, !1), e.clearAnchor(i), o.remove(), e.cancelAdd(), t.draw(), n();else n();
        }
      });
    });
  }, function (e, t, n) {
    n(1).registerBehaviour("hoverNodeAddOutter", function (e) {
      ...
      n.behaviourOn("node:mouseenter", function (n) {
        var r = n.item;
        e.getSignal("dragEdge") && (t = r, e.addOutterShape(r, {
          stroke: "#52C41A",
          strokeOpacity: .45,
          lineWidth: 4
        }));
    ...
    r.registerBehaviour("orbit", function (e) {
      ...
      n.behaviourOn("beforepanitem", function () {
        ...
        var r = n.item;
        e.getSignal("panningItem") || e.getSignal("dragEdge") || (t = r, e.showOrbit(r));
        ...
        if (t) {
          var s = t.getBBox(),
            ...
            y: u
              ...
              d = n.getMatrix()[0];
          a !== t && l > s.width / 2 + o.orbitGap / d && (e.hideOrbit(), t = void 0), t && e.layoutOrbit(t, {
            x: c,
            y: u
          });
        }
    ...
    function i(e, t, n, r) {
      ...
      if (e <= t && t <= n || e >= t && t >= n) {
        var a = (n - t) / 2,
            c = Math.abs(a);
        if (0 === a) return e === t ? 0 : (t - e) / Math.abs(t - e) * o;
      ...
      var s = o;
      return (s = Math.abs(t - n) < 2 * Math.abs(t - e) ? r * Math.abs(t - n) / (2 * Math.abs(t - e)) : r) > i && (s = i), s < o && (s = o), t > e ? s : -s;
    }
    ...
    function a(e, t, n, r) {
      ...
      return r && r.bbox && (s = Math.min(s, r.bbox.height, r.bbox.width)), u ? o = i(c.centerX, t.x, n.x, s) : a = i(c.centerY, t.y, n.y, s), {
        x: t.x + o,
        y: t.y + a
      };
    }
    ...
    function O(e, t, n, o, i, a, c) {
      ...
      for (var g = function g() {
        ...
        if (s.forEach(function (e) {
          f[e.id] < v && (v = f[e.id], m = e);
        }), m === n) {
          var b = [];
          return function e(t, n, r, o) {
            var i = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 0;
            t.unshift(n[o]), r[o] && r[o] !== o && i <= 100 && e(t, n, r, r[o], i + 1);
          }(b, h, l, n.id), {
            v: b
          };
        }

        g = m, (p = (r = s).indexOf(g)) > -1 && r.splice(p, 1), u.push(m), function (e, t, n, r) {
          var o = [];
          return e.forEach(function (e) {
          ...
          if (-1 === u.indexOf(e)) {
            ...
            var r = f[m.id] + S(m, e);
            d[e.id] && r >= d[e.id] || (l[e.id] = m.id, d[e.id] = r, f[e.id] = d[e.id] + w(e, n, t, a, c));
          }
        });
      }; s.length;) {
        var p = g();
      ...
      return console.error("cannot find path: ", e, t, n), [t, n];
    }

    function P(e, t, n, r, o) {
      var i = n && n.bbox ? n.bbox : d(e),
          a = r && r.bbox ? r.bbox : d(t);
      if (l(i, a)) return v(b(e, t));
      var c = f(i, o),
          u = f(a, o);
      if (l(c, u)) return v(b(e, t));
      ...
      }), _.unshift(m), _.push(y);
      var E = O(_ = x(_), m, y, i, a, e, t);
      return E.unshift(e), E.push(t), v(E);
    }

    function _(e, t) {
      var n = [],
          r = e[0];
      return n.push("M".concat(r.x, " ").concat(r.y)), e.forEach(function (r, i) {
        var a = e[i + 1],
            c = e[i + 2];
        if (a && c) {
          if (function (e, t, n) {
            ...
            var u = o(function (e, t, n, r) {
              ...
              return o < r && (r = o), i < r && (r = i), [{
                ...
                s = u[0],
                l = u[1];
            n.push("L".concat(s.x, " ").concat(s.y)), n.push("Q".concat(a.x, " ").concat(a.y, " ").concat(l.x, " ").concat(l.y)), n.push("L".concat(l.x, " ").concat(l.y));
    ...
    r.registerEdge("koni-base", {
      ...
      getPathByPoints: function getPathByPoints(e) {
        ...
        if (n && r) {
          ...
          }(n, s)) : (0 === c.length && s--, function (e, t, n) {
            var r = e.getBBox(),
                o = t.getBBox(),
                a = r.centerX,
                c = r.centerY,
    ...
    var r = n(8);
    r.Util = n(10), n(108), n(112), n(120), e.exports = r;
  }, function (e, t, n) {
    n(109), n(110), n(111);
  }, function (e, t, n) {
    var r = n(1),
    ...
    r.registerBehaviour("panMindNode", function (e) {
      ...
      function a() {
        t.nth = n;
        var o = i.add("node", t);
        e.setSelected(o, !0), r && i.remove(r.id);
      }

      function c() {
        i.emit("panitemend"), t = void 0, r = void 0, n = void 0;
      }

      i.behaviourOn("beforeshowdelegation", function () {
        e.clearSelected(), e.clearActived();
      }), i.behaviourOn("node:dragstart", function (e) {
        if (2 !== e.button) {
          var r = e.item;
          !(t = r.getModel()).parent || e.shape.isCollapsedButton || e.shape.isExpandedButton ? c() : (n = i.getNth(r), i.remove(r));
        }
        ...
        if (!t.shape || !t.shape.isPlaceholder) {
          ...
          if (r && (n ? r.id !== n.id && i.remove(i.find(r.id)) : i.remove(i.find(r.id))), r = n, n) {
            var a = n.parent;
            ...
            if (!i.find(n.id)) {
              ...
              n.side && (c.side = n.side), i.add("node", c);
            }
          }
        }
        ...
        if (t) if (r) {
          var u = o.clone(t);
          i.remove(r.id), e.executeCommand("moveMindNode", {
            model: u,
    ...
    i.registerNode("mind-base", {
      dy: 4,
      afterDraw: function afterDraw(e) {
        var t = e.getModel();
        t.children && t.children.length > 0 && t.collapsed && this.drawExpandedButton(e);
      },
      debugDrawLayoutPoint: function debugDrawLayoutPoint(e) {
        var t = e.getModel();
      ...
      drawExpandedButton: function drawExpandedButton(e) {
        ...
        n.addShape("circle", {
          ...
          capture: !1
        }), o.attr("lineAppendWidth", 20), n.translate(s.x, s.y), o.isExpandedButton = !0, o.isButton = !0;
      },
      drawCollapsedButton: function drawCollapsedButton(e) {
        var t = e.getKeyShape().getBBox(),
        ...
        n.translate(c.x, c.y), n.isCollapsedButton = !0, n.isButton = !0;
      },
      getButtonPositon: function getButtonPositon(e, t, n) {
        return "right" === n ? {
          x: e.maxX + 2,
      ...
      drawLabel: function drawLabel(e) {
        ...
        return this.adjustLabelText(i), this.adjustLabelPosition(e, i), i;
      },
      adjustLabelText: function adjustLabelText(e) {
        var t = e.attr("text"),
            n = e.getBBox();

        if (n.maxX - n.minX > 400) {
          var r = e.attr("font");
          t = a.getLabelTextByTextLineWidth(t, r), e.attr("text", t);
        }
      },
      adjustLabelPosition: function adjustLabelPosition(e, t) {
    ...
    r.registerNode("mind-placeholder", {
      ...
      getPath: function getPath(e) {
        var t,
            n = e.getModel().parentModel,
            r = this.getStyle(e),
            i = 0;
        return n.hierarchy <= 2 ? t = 28 : (t = 20, i = 4), o.getRectPath(-27.5, -t / 2 + i, 55, t, r.radius);
      },
      getStyle: function getStyle() {
        return {
          fill: "#91D5FF",
    ...
    n(8).registerEdge("mind-edge", {
      getEdetal: function getEdetal(e) {
      ...
      getPath: function getPath(e) {
        ...
        if (2 === a.hierarchy && (c = 66, u = 30), t[0].y === t[1].y) {
    ...
    n(8).registerEdge("mind-placeholder-edge", {
      getOriginShapeObject: function getOriginShapeObject(e) {
    ...
    r.registerCommand("append", {
      ...
      execute: function execute(e) {
        var t,
            ...
            u = c.hierarchy,
            s = a.getParent();
        if (a.isRoot) t = i(n, a, this.addItemId);else {
          var l = r.getNth(a);
          t = r.add("node", {
            id: this.addItemId,
            parent: s.id,
        ...
        n.clearSelected(), n.clearActived(), n.setSelected(t, !0), 1 === this.executeTimes && (this.selectedItemId = a.id, this.addItemId = t.id, n.beginEditLabel(t));
      },
      back: function back(e) {
        var t = e.getCurrentPage();
        t.getGraph().remove(this.addItemId), t.clearSelected(), t.clearActived(), t.setSelected(this.selectedItemId, !0);
      },
      shortcutCodes: ["Enter"]
      ...
      execute: function execute(e) {
        ...
        t = o.isRoot ? i(n, o, this.addItemId) : r.add("node", {
          ...
          parent: o.id,
          label: "新建节点"
        }), n.clearSelected(), n.clearActived(), n.setSelected(t, !0), 1 === this.executeTimes && (this.selectedItemId = o.id, this.addItemId = t.id, n.beginEditLabel(t));
      },
      back: function back(e) {
        var t = e.getCurrentPage();
        t.getGraph().remove(this.addItemId), t.clearSelected(), t.clearActived(), t.setSelected(this.selectedItemId, !0);
      ...
      execute: function execute(e) {
        ...
        delete c.shape, delete c.side, n.remove(c.id), o.mix(c, {
          parent: r,
          nth: i,
          side: a
        });
        var u = n.add("node", c);
        t.clearSelected(), t.setSelected(u, !0);
      },
      back: function back(e) {
        var t = e.getCurrentPage(),
            n = t.getGraph(),
    ...
    var u = n(6),
      ...
      return function (e, t) {
        ...
        value: function value() {
          ...
          if (!e) throw new Error("please set the container for the toolbar !");
    ...
    var u = n(6),
      ...
      return function (e, t) {
        ...
        value: function value() {
          var e = this.container;
          if (!e) throw new Error("please set the container for the tontextmenu !");
          u.isString(e) && (e = document.getElementById(e));
          var t = e.getElementsByClassName("command");
          e.style.position = "absolute", e.style["z-index"] = 2, e.style.top = "0px", e.style.left = "0px", this.commands = t, this.containerDom = e;
        }
      }, {
        key: "bindEvent",
        value: function value() {
        ...
        value: function value() {
          ...
          this.editor.getCurrentPage().setSignal("preventWheelPan", !0), e.style.display = "block";
        }
      }, {
        key: "hide",
        value: function value() {
          var e = this.containerDom;
          this.editor.getCurrentPage().setSignal("preventWheelPan", !1), e.style.display = "none";
        }
      }, {
        key: "move",
        value: function value(e, t) {
          ...
          n.style.left = i + (e - r.left) + "px", n.style.top = o + (t - r.top) + "px";
        }
      }]) && o(n.prototype, r), l && o(n, l), t;
    }();
    ...
    n(12).registerBehaviour("bpmnMoveEdgeController", function (e) {
      ...
      function c() {
        e.set("panItemDelegation", void 0), e.set("panItemStartBox", void 0), e.set("panItemStartPoint", void 0), t = void 0;
      }
      ...
      n.behaviourOn("edge:mouseenter", function (t) {
        ...
        t = e.getDelegation([r], o), e.set("bpmnNodePanDelegation", t), e.set("bpmnNodePanStartBox", r), e.set("bpmnNodePanStartPoint", {
          x: n.x,
          y: n.y
      ...
      n.on("node:mouseenter", function (a) {
        if (!e.getSignal("panningItem") && !e.getSignal("dragEdge")) {
          ...
          c.css({
            ...
            top: p.y - i / 2 + "px",
            left: p.x + 10 + "px"
          }), c.setAttribute("anchorIndex", 0), u.setAttribute("anchorIndex", 2), s.setAttribute("anchorIndex", 3), l.setAttribute("anchorIndex", 1), e.showArrowController(t);
        }
        ...
        if (t) {
          var a = t.getBBox(),
              ...
              l = a.maxX + c,
              d = a.maxY + c;
          (r < u || i < s || r > l || i > d) && (e.hideArrowController(), t = void 0);
        }
      });
    });
  }, function (e, t, n) {
    n(128), n(12).registerNode("bpmn-base", {
      anchor: null
    });
  }, function (e, t, n) {
    "use strict";
    ...
    function a(e) {
      ...
      switch (r) {
        case "ROUNDED_RECT":
          if (o[a[i]] >= t[c[i]] + 4 && o[a[i]] <= t[u[i]] - 4) return {
            added: void 0,
            joint: {
          ...
          if (o[a[i]] >= t[c[i]] && o[a[i]] < t[c[i]] + 4) return {
            added: void 0,
            joint: {
          ...
          if (o[a[i]] >= t[u[i]] - 4 && o[a[i]] <= t[u[i]]) return {
            added: void 0,
            joint: {
        ...
        case "CIRCLE":
          if (o[a[i]] >= t[c[i]] && o[a[i]] <= t[u[i]]) return {
            added: void 0,
            joint: {
    ...
    o.a.registerEdge("bpmn-base", {
      getPath: function getPath(e) {
        ...
        if (o.edgeMoved && o.lastMouse) {
          ...
          if (0 === g && n && (p[0] = l, s && (p.splice(1, 0, s), e.model.hold.index += 1)), r) {
            var v = a({
              bbox: r.getBBox(),
              point: m,
              vertical: o.hold.vertical,
          ...
          g === h.length - 2 && r && (s && 0 === g ? (p[2] = f, d && p.splice(2, 0, d)) : (p[1] = f, d && p.splice(1, 0, d))), (u = o.controlPoints).splice.apply(u, [g, 2].concat(p)), n && Object(i.l)(l, h, o.hold.index) && (h.splice(0, o.hold.index), o.hold.index = 0, h[0] = l), r && Object(i.l)(f, h, o.hold.index) && (o.controlPoints.splice(o.hold.index + 1), h[o.hold.index + 1] = f), t = Object(c.mergeLine)(e, g), function (e, t, n) {
        ...
        } else if (o.modifiedByMouse && o.nodeMoved) !function (e, t, n) {
          if (e.nodeMoved) {
            ...
            if (2 === s.length) {
              var l = Object(i.d)(t, n),
                  d = l.sourcePoint,
                  f = l.targetPoint;
              e.sourceJoint && d.index === e.sourceJoint.index && (d.point = Object(i.c)(t.getBBox())[d.index], d.point.x += e.sourceJoint.delta.x, d.point.y += e.sourceJoint.delta.y), e.targetJoint && f.index === e.targetJoint.index && (f.point = Object(i.c)(n.getBBox())[f.index], f.point.x += e.targetJoint.delta.x, f.point.y += e.targetJoint.delta.y);
              ...
              if (m === y) {
                ...
                if (3 === s.length) {
                  ...
                  if (r) {
                    ...
                    e.controlPoints.splice(0, 3, k, A), e.sourceJoint = {
                      index: C,
                      delta: {
                        x: 0,
                        y: 0
                    ...
                    e.controlPoints.splice(g, 3, M, k), e.targetJoint = {
                      index: C,
                      delta: {
                        x: 0,
                        y: 0
                ...
                var B = Object(i.k)(v.index),
                    j = Object(i.c)(a)[B],
                    X = Object(i.g)(j, s, g);
                r ? (e.controlPoints.splice(0, 2, j, X), e.sourceJoint = {
                  index: B,
                  delta: {
                    x: 0,
                    y: 0
                  }
                }) : o && (e.controlPoints.splice(g + 1, 2, X, j), e.targetJoint = {
                  index: B,
                  delta: {
                    x: 0,
                    y: 0
        ...
        }(o, n, r);else if (!o.modifiedByMouse) {
          var b = o.anchorIndex,
      ...
      draw: function draw(e) {
        ...
        return a && (n.helpLine = a, n.helpLineTime = new Date().getTime()), !a && new Date().getTime() - n.helpLineTime >= 150 && (n.helpLine = void 0, n.helpLineTime = void 0), n.helpLine && t.addShape("path", {
          attrs: {
